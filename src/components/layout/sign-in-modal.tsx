...
export const SignInModal = () => {
  ...
  return (
    <Modal showModal={signInModal.isOpen} setShowModal={signInModal.onClose}>
      <DialogContent className="border-0 bg-white text-transparent dark:bg-black">
        <Card className="z-[51] w-full border-0 max-sm:flex max-sm:flex-col max-sm:items-center max-sm:justify-center max-sm:rounded-none max-sm:border-none">
          <CardHeader className="space-y-1">
            <div className="flex items-center justify-between">
