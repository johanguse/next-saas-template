...
export default function PlansTableNST() {
    ...
    <div>
      ...
      <div className="m-auto mb-8 flex max-w-[14rem] justify-center lg:mb-16">
        <div className="relative flex w-full rounded-full bg-white p-1 dark:bg-slate-900">
          ...
          >
            <span
              className={`absolute inset-0 w-1/2 rounded-full bg-indigo-500 shadow-sm shadow-indigo-950/10 transition-transform duration-150 ease-in-out dark:shadow-slate-600${
                isAnnual
                  ? 'translate-x-0'
                  : 'translate-x-full bg-white shadow-none dark:bg-slate-900'
              }`}
            ></span>
          </span>
          <button
            className={`relative h-8 flex-1 rounded-full text-sm font-medium transition-colors duration-150 ease-in-out focus-visible:outline-none focus-visible:ring focus-visible:ring-indigo-300 dark:focus-visible:ring-slate-600 ${
              isAnnual
                ? 'text-white shadow-sm shadow-indigo-950/10 dark:shadow-slate-600'
          ...
          <button
            className={`relative h-8 flex-1 rounded-full text-sm font-medium transition-colors duration-150 ease-in-out focus-visible:outline-none focus-visible:ring focus-visible:ring-indigo-300 dark:focus-visible:ring-slate-600 ${
              isAnnual
                ? 'text-slate-500 dark:text-slate-400'
                : 'bg-indigo-500 text-white shadow-sm shadow-indigo-950/10 dark:shadow-slate-600'
            }`}
